...
const FunctionDisplay = ({ toolCall }) => {
    ...
    const statusConfig = {
        ...
        completed: isError ? 
            ...
            { icon: CheckCircle2, color: 'text-emerald-600', text: 'Sucesso' },
        success: { icon: CheckCircle2, color: 'text-emerald-600', text: 'Sucesso' },
...
export default function MessageBubble({ message }) {
    ...
    return (
        <div className={cn("flex gap-3 mb-4", isUser ? "justify-end" : "justify-start")}>
            {!isUser && (
                <div className="h-8 w-8 rounded-full bg-emerald-100 flex items-center justify-center mt-0.5 flex-shrink-0">
            ...
            <div className={cn("max-w-[85%]", isUser && "flex flex-col items-end")}>
                {message.content && (
                    <div className={cn(
                        ...
                        isUser ? "bg-emerald-600 text-white" : "bg-white border border-gray-100"
                    )}>
                        {isUser ? (
                ...
                {message.image_url && (
                    <div className="mt-2 rounded-xl overflow-hidden border border-gray-200 max-w-xs">
                        <img src={message.image_url} alt="Upload do usuário" className="w-full h-auto" />
                    </div>
                )}
